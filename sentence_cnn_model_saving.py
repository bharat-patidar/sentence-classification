...
test_comments=['we are going to mountain do you want to come along with me because we are going to a very cool place where you will find a lot of lions', 'i have a question that where are you going is not it a very scary place where you will find lot of scary content',
               'this is what we are expecting and we hope you understand too we dont want to make it more complex this is very simple is it clear to you','can you do this please we hope its not very difficult for you',
               'go there and take it back because its very important for us and we need it anyhow in any condition I hope you can understand it','I like his item, order this for me ']
test_comments_category=['statement','statement','statement','statement','statement','statement']

test_out=[0, 0, 1, 0, 2, 2]